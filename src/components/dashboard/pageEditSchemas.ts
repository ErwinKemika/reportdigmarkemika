  ...
  arrayFields: [
    ...
    },
    {
      ...
      columns: [
        ...
        { key: "tag", label: "Tag", type: "select", options: ["Ads", "Artikel (SEO)", "UX", "Campaign", "Editing", "Shooting", "Event"] },
        { key: "priority", label: "Priority", type: "select", options: ["High", "Medium", "Low"] },
        { key: "status", label: "Status", type: "select", options: ["Done", "Ongoing", "Pending", "Blocked"] },
