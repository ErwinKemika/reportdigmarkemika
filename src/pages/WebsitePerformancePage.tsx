...
const CHART_COLORS_LIGHT = ["hsl(222,47%,25%)", "hsl(217,91%,60%)", "hsl(45,93%,47%)", "hsl(25,95%,53%)"];
const CHART_COLORS_DARK = ["hsl(199,89%,68%)", "hsl(262,83%,68%)", "hsl(45,93%,58%)", "hsl(25,95%,65%)"];
